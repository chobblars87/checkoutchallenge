	...
	$body = '<div id="main">
				<div class="container">
						...
						<div class="challenge card-body">
							<hr class="mb-4">
								...
								<div class="intro">
									...
									With the Drop-in solution handing the front-end, you would be able display the required fields for each payment method without needing to know the actual flow of each payment method.
					...
					$footer = '<div id="footer">
									...
									In order to interface with the Adyen API\'s, you would normally be required to generate a new API Key for your "WS User". However for ease, please use the following key for all Adyen API interactions:<br/><br/>
									<div style="margin-left: 40px"><code>AQE1hmfxKo3NaxZDw0m/n3Q5qf3Ve55dHZxYTFdTxWq+l3JOk8J4BO7yyZBJ4o0JviXqoc8j9sYQwV1bDb7kfNy1WIxIIkxgBw==-q7XjkkN/Cud0WELZF+AzXpp/PuCB8+XmcdgqHYUWzTA=-Kk9N4dG837tIyjZF</code></div>
									<br/>
									<div id="caReg">
										<div class="instructions">
											The next step is to create a user for the Adyen Dashboard. This is where you can access our portal in to the platform, and see your payments coming in once you\'ve completed the first part of the integration and can help diagnose any problems you may be facing during your integration.
										</div>
										<form id="reqUser">
											<br/>
											<div class="instructions" ';
...
<html>
	...
	<body>
		...
		<script>
			...
			var emailhtml = '<?php echo base64_encode(htmlentities(/*$styles . */$body . $endbody)); ?>';
